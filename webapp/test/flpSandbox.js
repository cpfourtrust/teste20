		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "teste20",
									"targetURL": "#fourtrustteste20-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fourtrustteste20-display": {
								"semanticObject": "fourtrustteste20",
								"action": "display",
								"description": "teste20",
								"title": "teste20",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fourtrust.teste20",
									"url": sap.ui.require.toUrl("fourtrust/teste20")
								}
							}
						}
					}
